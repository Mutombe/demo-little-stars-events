...
function HeroSection() {
  ...
  const heroImages = hero.backgroundImages?.map(img => img.url) || ['https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=1200&q=80','https://images.unsplash.com/photo-1505236858219-8359eb29e329?w=1200&q=80','https://images.unsplash.com/photo-1519741497674-611481863552?w=1200&q=80'];
    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <AnimatePresence mode="sync">
          <motion.img key={currentSlide} src={heroImages[currentSlide]} alt="Little Stars Events"
      ...
      <motion.div className="relative z-20 flex flex-col justify-center h-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pt-36"
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.2 }}
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            {hero.trustLine || '4.5 Stars \u00b7 6+ Reviews \u00b7 Harare'}
          </p>
        </motion.div>
...
function ServicesGrid() {
  ...
  const fi = ['https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=800&q=80','https://images.unsplash.com/photo-1505236858219-8359eb29e329?w=800&q=80','https://images.unsplash.com/photo-1519741497674-611481863552?w=800&q=80','https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&q=80','https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=800&q=80','https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=800&q=80'];
  return (
...
function StatsBand() {
  ...
  const ds = stats?.length ? stats : [{ number: '6', label: 'Reviews' }, { number: '200', label: 'Events' }, { number: '4.5', label: 'Rating' }, { number: '5', label: 'Years' }];
  return (
...
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={homeCta?.backgroundImage || 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=1200&q=80'} alt="Little Stars Events" className="w-full h-[130%] object-cover object-center" loading="eager" />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href={`https://wa.me/${business.whatsappNumber || '263773287720'}`} target="_blank" rel="noopener noreferrer"
